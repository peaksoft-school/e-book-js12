...
const LastPublicationSection: FC = () => {
    ...
    const [navClicked, setNavClicked] = useState(() => {
        ...
        return savedNavClicked ? JSON.parse(savedNavClicked) : 'BUSINESS_LITERATURE';
    });
                                ...
                                <ul>
                                    <li>
                                        <button
                                            ...
                                            className={navClicked === 'BUSINESS_LITERATURE' ? 'active' : ''}
                                        >
                                            Бизнес-литература
                                        </button>
                                    </li>
                                    <li>
                                        <button
                                            ...
                                            className={navClicked === 'BOOKS_FOR_CHILDREN' ? 'active' : ''}
                                        >
                                            Детские книги
                                        </button>
                                    </li>
                                    ...
                                    <li>
                                        <button
                                            ...
                                            className={navClicked === 'ARTISTIC_LITERATURE' ? 'active' : ''}
                                        >
                        ...
                        {data?.map((el) => (
                            <div key={el.id} className={scss.main_about}>
                                ...
                                <div className={scss.about_book_footer}>
                                    <a className={scss.nav_to_all} href="#" onClick={() =>navigate(`${el.id}`)}>
                                        Подробнее
                                    </a>
